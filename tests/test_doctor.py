...
def test_doctor_payload_reports_readiness_config_version_and_tool_count(tmp_path):
    ...
    assert payload["runtime_policy"]["effective_allowed_tool_count"] == "25"
    assert payload["runtime_policy"]["approval_required_tool_count"] == "5"
...
def test_doctor_payload_reports_runtime_policy_without_tokens(tmp_path):
    ...
    assert payload["runtime_policy"]["approval_required_tool_count"] == "29"
