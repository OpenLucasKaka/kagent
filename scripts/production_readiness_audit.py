...
REQUIRED_PROMETHEUS_ALERTS = (
    ...
    "kagentRuntimeReconciliationErrors",
    "kagentRuntimeInterruptedRunsRecovered",
    "kagentRuntimePlannerFailures",
    "kagentRuntimeLLMProviderFailures",
    "kagentRuntimeToolExecutionFailures",
    "kagentRuntimeToolApprovalPressure",
    "kagentRuntimeToolExecutionTimeouts",
    "kagentTracePersistenceFailures",
    "kagentConcurrencySaturated",
    "kagentIdempotencyWaitTimeouts",
    "kagentIdempotencyTakeovers",
...
REQUIRED_PROMETHEUS_RULE_METRICS = (
    ...
    "kagent_runtime_hook_failures_total",
    "kagent_runtime_reconciliation_errors_total",
    "kagent_idempotency_cache_wait_timeouts",
    "kagent_idempotency_cache_takeovers",
    "kagent_runtime_reconciliation_outcomes_total",
    "kagent_runtime_observation_errors_total",
